...
def batch_process_kif(path: str, default_ply: Optional[int] = None,
    ...
    written: List[str] = []
    written.append(str(generate_kif_single_line(board0, hands_b, gote_auto, "", "", paths[0], f"{base}.kif")))
    for j, mvlist in enumerate(paths[1:], start=2):
        fname = f"{base}_{j:03d}.kif"
        written.append(str(generate_kif_single_line(board0, hands_b, gote_auto, "", "", mvlist, fname)))
